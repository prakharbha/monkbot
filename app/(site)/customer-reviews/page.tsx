...
export default function CustomerReviewsPage() {
    const testimonials = [
        ...
        {
            text: "I was skeptical at first, but MonkBot's ability to seamlessly generate and publish content strictly adhering to our brand guidelines is mind-blowing. It saved us countless hours of manual work.",
            author: "Jason Lee",
        ...
        {
            text: "We replaced three disparate automation tools with just Monkbot. From WooCommerce order syncing to SEO meta descriptions, it behaves as the perfect orchestration layer.",
            author: "Samantha Bright",
            ...
            <section className="bg-white border-b border-gray-100 py-20 px-4 md:px-6 w-full">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <p className="text-xl text-gray-600 font-light max-w-2xl mx-auto">
                        Don't just take our word for it. Read the reviews and see how teams are managing their fleets with agentic workflows.
                    </p>
                </div>
            </section>

            {/* Masonry / Grid Layout for Feedback */}
            <section className="w-full px-4 md:px-6 py-20 bg-gray-50/50">
                <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-min">
