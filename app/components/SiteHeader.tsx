                    ...
                    <div className="flex items-center justify-between h-14 lg:h-16 xl:h-20">
                        ...
                        <div className="hidden lg:flex lg:items-center w-full gap-8 xl:gap-16">
                            ...
                            <div className="flex items-center gap-2 xl:gap-4">
                                ...
                                <Link href="/sign-up" className="inline-flex items-center rounded-md tracking-tight bg-foreground border border-foreground px-3 xl:px-4 py-1 text-white text-sm xl:text-base font-normal transition-colors duration-200">Get started</Link>
                            </div>
                        </div>
                        ...
                        <div className="flex lg:hidden items-center justify-between w-full">
                            ...
                            <div className="flex items-center gap-3 z-[60]">
                                <Link href="/sign-up" className="inline-flex items-center rounded-md tracking-tight bg-foreground border border-foreground px-3 py-1 text-white text-sm font-normal transition-colors duration-200">Get started</Link>
                                <button
            ...
            {mobileMenuOpen && (
                <div className="fixed inset-0 z-50 bg-white flex flex-col pt-6 px-6 lg:hidden overflow-y-auto w-full h-full">
                    ...
                    <div className="mt-4 flex flex-col gap-4">
                        ...
                        <Link href="/sign-up" className="w-full text-center rounded-lg bg-foreground text-white font-medium px-6 py-3" onClick={() => setMobileMenuOpen(false)}>Get started</Link>
                    </div>
                </div>
            )}
        </>
