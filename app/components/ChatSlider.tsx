            ...
            <div className="bg-[#f8f9fa] border border-gray-200 rounded-2xl p-4 md:p-8 pt-[10px] md:pt-[10px] min-h-[560px] flex flex-col justify-between relative overflow-hidden transition-all duration-500 ease-in-out">
                ...
                <div className="w-full flex justify-between items-center">
                    ...
                    <div className="flex items-center gap-2">
                        <button onClick={prevSlide} aria-label="Previous slide" className="p-1 rounded-md hover:bg-gray-200 text-gray-500 transition-colors">
                            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" /></svg>
                        </button>
                        <span className="text-xs font-medium text-gray-600">{currentIndex + 1} / {CHAT_SLIDES.length}</span>
                        <button onClick={nextSlide} aria-label="Next slide" className="p-1 rounded-md hover:bg-gray-200 text-gray-500 transition-colors">
                        ...
                        >
                            ...
                            <div className="chat-bubble chat-bubble-agent relative mt-4 block">
                                <div className="flex items-center gap-2 mb-2">
                                    <Image src="/brand/monkbot-logo.png" alt="MonkBot" width={60} height={20} className="h-5 w-auto grayscale" style={{ width: "auto" }} />
